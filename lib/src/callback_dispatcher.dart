...
import 'package:flutter_geofence/src/geofencing.dart';
import 'package:flutter_geofence/src/location.dart';
...
void callbackDispatcher() {
  ...
  _backgroundChannel.setMethodCallHandler((MethodCall call) async {
    ...
    print(triggeringGeofences);
    print(triggeringLocation);
    print(event);
